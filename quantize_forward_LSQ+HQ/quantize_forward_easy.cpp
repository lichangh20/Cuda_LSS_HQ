...
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor, std::vector<double>, torch::Tensor, long long int> quantize(torch::Tensor hx, torch::Tensor hy, float scale_x, float scale_y){
