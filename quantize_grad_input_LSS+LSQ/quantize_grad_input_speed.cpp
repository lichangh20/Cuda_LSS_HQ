...
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor> quantize(torch::Tensor x, int num_bits, torch::Tensor qy, float scaley, torch::Tensor hadamard_activation, torch::Tensor scale_activation){
